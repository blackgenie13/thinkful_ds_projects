...
un_data = pd.read_csv('C:/Users/Michael Lin_2/Desktop/Thinkful/Data/un.csv')
...
for k in range(1,11):
    ...
    # e_dist = Wk(centroids1, cluster1)
    idx1,idxdist1 = vq(cluster1,centroids1)
    avg_dist = np.mean(idxdist1)
    average_distance.append(avg_dist)
    # eucledean_dist.append(e_dist)
